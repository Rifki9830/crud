        ...
        // </div>
            ...
            <tr key={index}>
              <td className='border border-slate-700 p-2.5 text-center'>
                {/* icon edit */}
                <Link href={`/edit/${btoa(data.npm)}`} className='bg-sky-700 text-white py-5X px-2.5 rounded-md mr-1' title='Ubah Data'>
                  <FontAwesomeIcon icon={faPencil}></FontAwesomeIcon>
                </Link>

                {/* icon delete */}
                <Link href={"/"} className='bg-red-600 text-white py-5X px-2.5 rounded-md ml-1' title='Hapus Data' 
